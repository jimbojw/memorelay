...
export declare const OUTGOING_EOSE_MESSAGE_EVENT_TYPE = "outgoing-eose-message";
/**
 ...
 */
export declare class OutgoingEOSEMessageEvent extends ClientEvent<typeof OUTGOING_EOSE_MESSAGE_EVENT_TYPE, OutgoingEOSEMessageEventDetails> {
    static readonly type: typeof OUTGOING_EOSE_MESSAGE_EVENT_TYPE;
    constructor(details: OutgoingEOSEMessageEventDetails, options?: ClientEventOptions);
}
