...
export declare const OUTGOING_NOTICE_MESSAGE_EVENT_TYPE = "outgoing-notice-message";
/**
 ...
 */
export declare class OutgoingNoticeMessageEvent extends ClientEvent<typeof OUTGOING_NOTICE_MESSAGE_EVENT_TYPE, OutgoingNoticeMessageEventDetails> {
    static readonly type: typeof OUTGOING_NOTICE_MESSAGE_EVENT_TYPE;
    constructor(details: OutgoingNoticeMessageEventDetails, options?: ClientEventOptions);
}
