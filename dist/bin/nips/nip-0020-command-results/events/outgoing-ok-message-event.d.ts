...
export declare const OUTGOING_OK_MESSAGE_EVENT_TYPE = "outgoing-ok-message";
/**
 ...
 */
export declare class OutgoingOKMessageEvent extends ClientEvent<typeof OUTGOING_OK_MESSAGE_EVENT_TYPE, OutgoingOKMessageEventDetails> {
    static readonly type: typeof OUTGOING_OK_MESSAGE_EVENT_TYPE;
    constructor(details: OutgoingOKMessageEventDetails, options?: ClientEventOptions);
}
