...
export declare const WEB_SOCKET_CLOSE_EVENT_TYPE = "web-socket-close";
/**
 ...
 * 'message' event.
 */
export declare class WebSocketCloseEvent extends ClientEvent<typeof WEB_SOCKET_CLOSE_EVENT_TYPE, WebSocketCloseEventDetails> {
    static readonly type: typeof WEB_SOCKET_CLOSE_EVENT_TYPE;
    constructor(details: WebSocketCloseEventDetails, options?: ClientEventOptions);
}
