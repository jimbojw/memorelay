...
export declare const MEMORELAY_CLIENT_DISCONNECT_EVENT_TYPE = "memorelay-client-disconnect";
/**
 ...
 * WebSocket.
 */
export declare class MemorelayClientDisconnectEvent extends ClientEvent<typeof MEMORELAY_CLIENT_DISCONNECT_EVENT_TYPE, MemorelayClientDisconnectEventDetails> {
    static readonly type: typeof MEMORELAY_CLIENT_DISCONNECT_EVENT_TYPE;
    constructor(details: MemorelayClientDisconnectEventDetails, options?: ClientEventOptions);
}
