...
export declare const INCOMING_EVENT_MESSAGE_EVENT_TYPE = "incoming-event-message";
/**
 ...
 */
export declare class IncomingEventMessageEvent extends ClientEvent<typeof INCOMING_EVENT_MESSAGE_EVENT_TYPE, IncomingEventMessageEventDetails> {
    static readonly type: typeof INCOMING_EVENT_MESSAGE_EVENT_TYPE;
    constructor(details: IncomingEventMessageEventDetails, options?: ClientEventOptions);
}
