...
export declare const INCOMING_CLOSE_MESSAGE_EVENT_TYPE = "incoming-close-message";
/**
 ...
 */
export declare class IncomingCloseMessageEvent extends ClientEvent<typeof INCOMING_CLOSE_MESSAGE_EVENT_TYPE, IncomingCloseMessageEventDetails> {
    static readonly type: typeof INCOMING_CLOSE_MESSAGE_EVENT_TYPE;
    constructor(details: IncomingCloseMessageEventDetails, options?: ClientEventOptions);
}
