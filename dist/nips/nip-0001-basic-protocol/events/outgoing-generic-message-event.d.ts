...
export declare const OUTGOING_GENERIC_MESSAGE_EVENT_TYPE = "outgoing-generic-message";
/**
 ...
 */
export declare class OutgoingGenericMessageEvent extends ClientEvent<typeof OUTGOING_GENERIC_MESSAGE_EVENT_TYPE, OutgoingGenericMessageEventDetails> {
    static readonly type: typeof OUTGOING_GENERIC_MESSAGE_EVENT_TYPE;
    constructor(details: OutgoingGenericMessageEventDetails, options?: ClientEventOptions);
}
