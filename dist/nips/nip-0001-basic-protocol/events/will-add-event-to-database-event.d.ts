...
export declare const WILL_ADD_EVENT_TO_DATABASE_EVENT_TYPE = "will-add-event-to-database";
/**
 ...
 */
export declare class WillAddEventToDatabaseEvent extends ClientEvent<typeof WILL_ADD_EVENT_TO_DATABASE_EVENT_TYPE, WillAddEventToDatabaseEventDetails> {
    static readonly type: typeof WILL_ADD_EVENT_TO_DATABASE_EVENT_TYPE;
    constructor(details: WillAddEventToDatabaseEventDetails, options?: ClientEventOptions);
}
