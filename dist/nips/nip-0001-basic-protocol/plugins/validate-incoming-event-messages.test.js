...
describe('validateIncomingEventMessages()', () => {
    describe('#IncomingGenericMessageEvent', () => {
        it('should validate an EVENT message', () => __awaiter(void 0, void 0, void 0, function* () {
            const { memorelayClient } = (0, setup_test_hub_and_client_1.setupTestHubAndClient)(validate_incoming_event_messages_1.validateIncomingEventMessages);
            const mockMessageHandler = jest.fn();
            memorelayClient.onEvent(incoming_event_message_event_1.IncomingEventMessageEvent, mockMessageHandler);
            ...
            expect(incomingEventMessageEvent).toBeInstanceOf(incoming_event_message_event_1.IncomingEventMessageEvent);
            expect(incomingEventMessageEvent.details.clientEventMessage).toEqual([
                'EVENT',
                nostrEvent,
            ]);
            expect(incomingEventMessageEvent.parentEvent).toBe(incomingGenericMessageEvent);
            expect(incomingEventMessageEvent.targetEmitter).toBe(memorelayClient);
        }));
        it('should ignore an EVENT message if defaultPrevented', () => __awaiter(void 0, void 0, void 0, function* () {
            const { memorelayClient } = (0, setup_test_hub_and_client_1.setupTestHubAndClient)(validate_incoming_event_messages_1.validateIncomingEventMessages);
            const mockMessageHandler = jest.fn();
            memorelayClient.onEvent(incoming_event_message_event_1.IncomingEventMessageEvent, mockMessageHandler);
            const nostrEvent = (0, signed_test_event_1.createSignedTestEvent)({ content: 'HELLO WORLD' });
        ...
        it('should ignore non-EVENT messages', () => __awaiter(void 0, void 0, void 0, function* () {
            const { memorelayClient } = (0, setup_test_hub_and_client_1.setupTestHubAndClient)(validate_incoming_event_messages_1.validateIncomingEventMessages);
            const mockMessageHandler = jest.fn();
            memorelayClient.onEvent(incoming_event_message_event_1.IncomingEventMessageEvent, mockMessageHandler);
            const incomingGenericMessageEvent = new incoming_generic_message_event_1.IncomingGenericMessageEvent({
        ...
        it('should emit an error when EVENT message is malformed', () => __awaiter(void 0, void 0, void 0, function* () {
            const { memorelayClient } = (0, setup_test_hub_and_client_1.setupTestHubAndClient)(validate_incoming_event_messages_1.validateIncomingEventMessages);
