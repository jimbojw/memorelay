...
export const CBOR_DECODING_ERROR_EVENT_TYPE = 'cbor-decoding-error';
 ...
 */
export class CborDecodingErrorEvent extends ClientEvent<
  typeof CBOR_DECODING_ERROR_EVENT_TYPE,
  CborDecodingErrorEventDetails
> {
  static readonly type: typeof CBOR_DECODING_ERROR_EVENT_TYPE =
    CBOR_DECODING_ERROR_EVENT_TYPE;
  constructor(
    details: CborDecodingErrorEventDetails,
    options?: ClientEventOptions
  ) {
    super(CBOR_DECODING_ERROR_EVENT_TYPE, details, options);
  }
}
