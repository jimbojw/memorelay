...
export const DUPLICATE_WEB_SOCKET_ERROR_EVENT_TYPE =
  'duplicate-web-socket-error';
 ...
 */
export class DuplicateWebSocketErrorEvent extends RelayEvent<
  typeof DUPLICATE_WEB_SOCKET_ERROR_EVENT_TYPE,
  DuplicateWebSocketErrorEventDetails
> {
  static readonly type: typeof DUPLICATE_WEB_SOCKET_ERROR_EVENT_TYPE =
    DUPLICATE_WEB_SOCKET_ERROR_EVENT_TYPE;
  constructor(
    details: DuplicateWebSocketErrorEventDetails,
    options?: RelayEventOptions
  ) {
    super(DUPLICATE_WEB_SOCKET_ERROR_EVENT_TYPE, details, options);
  }
}
