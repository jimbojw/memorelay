...
export const PREFLIGHT_EVENT_TYPE = 'preflight-event';

/**
 * @see PreflightEvent
 */
export interface PreflightEventDetails<
 ...
 * unknown event types.
 */
export class PreflightEvent<
  EventType extends BasicEvent = BasicEvent
> extends BasicEvent<
  typeof PREFLIGHT_EVENT_TYPE,
  PreflightEventDetails<EventType>
> {
  static readonly type: typeof PREFLIGHT_EVENT_TYPE = PREFLIGHT_EVENT_TYPE;
  constructor(
    details: PreflightEventDetails<EventType>,
    options?: BasicEventOptions
  ) {
    super(PREFLIGHT_EVENT_TYPE, details, options);
  }
}
