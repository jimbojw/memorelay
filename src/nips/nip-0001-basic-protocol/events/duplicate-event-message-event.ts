...
export const DUPLICATE_EVENT_MESSAGE_EVENT_TYPE = 'duplicate-event-message';
 ...
 * event.
 */
export class DuplicateEventMessageEvent extends ClientEvent<
  typeof DUPLICATE_EVENT_MESSAGE_EVENT_TYPE,
  DuplicateEventMessageEventDetails
> {
  static readonly type: typeof DUPLICATE_EVENT_MESSAGE_EVENT_TYPE =
    DUPLICATE_EVENT_MESSAGE_EVENT_TYPE;
  constructor(
    details: DuplicateEventMessageEventDetails,
    options?: ClientEventOptions
  ) {
    super(DUPLICATE_EVENT_MESSAGE_EVENT_TYPE, details, options);
  }
}
